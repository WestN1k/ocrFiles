...
public class LocalDateTableCell<T> extends TableCell<T, LocalDate> {
    private static final String MEDIUM = "dd.MM.yyyy";  //шаблон отображения на экране
    private static final DateTimeFormatter formatter = DateTimeFormatter.ofPattern(MEDIUM);
